...
public class MonthRasterStatisticsProcess extends BaseJob {
    private static final Logger logger = Logger.getLogger(MonthRasterStatisticsProcess.class);
    ...
    public void startJob(JobExecutionContext jobExecutionContext) throws JobExecutionException {
        ...
        if (jobExecutionContext != null) {
            ...
            config = (Map<String, Object>) ConstantUtil.get("MonthRasterStatisticsProcess");
        }
