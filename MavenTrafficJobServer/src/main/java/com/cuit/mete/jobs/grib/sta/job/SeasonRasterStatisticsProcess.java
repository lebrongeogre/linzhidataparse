...
public class SeasonRasterStatisticsProcess extends BaseJob {
    private static final Logger logger = Logger.getLogger(SeasonRasterStatisticsProcess.class);
    ...
    public void startJob(JobExecutionContext jobExecutionContext) throws JobExecutionException {
        ...
        if (jobExecutionContext != null) {
            ...
            config = (Map<String, Object>) ConstantUtil.get("SeasonRasterStatisticsProcess");
        }
