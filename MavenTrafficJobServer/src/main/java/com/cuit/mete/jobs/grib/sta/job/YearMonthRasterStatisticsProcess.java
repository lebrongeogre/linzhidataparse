...
public class YearMonthRasterStatisticsProcess extends BaseJob {
    private static final Logger logger = Logger.getLogger(YearMonthRasterStatisticsProcess.class);
    ...
    public void startJob(JobExecutionContext jobExecutionContext) throws JobExecutionException {
        if (jobExecutionContext != null) {
            ...
            config = (Map<String, Object>) ConstantUtil.get("YearMonthRasterStatisticsProcess");
        }
