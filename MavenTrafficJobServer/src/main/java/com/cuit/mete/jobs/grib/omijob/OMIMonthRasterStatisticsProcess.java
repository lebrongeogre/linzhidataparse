...
import com.cuit.mete.jobs.grib.sta.utils.imp.MonthFileUtils;
...
public class OMIMonthRasterStatisticsProcess extends BaseJob {
    private static final Logger logger = Logger.getLogger(OMIMonthRasterStatisticsProcess.class);
    ...
    public void startJob(JobExecutionContext jobExecutionContext) throws JobExecutionException {
        ...
        if (jobExecutionContext != null) {
            ...
            config = (Map<String, Object>) ConstantUtil.get("OMIMonthRasterStatisticsProcess");
        }
        ...
        //按月份过滤文件列表，依次计算均值
        rasterCalSave = new RasterCalSave(new MonthFileUtils());
