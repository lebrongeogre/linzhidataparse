...
public class YearRasterStatisticsProcess extends BaseJob {
    private static final Logger logger = Logger.getLogger(YearRasterStatisticsProcess.class);
    ...
    public void startJob(JobExecutionContext jobExecutionContext) throws JobExecutionException {
        ...
        if (jobExecutionContext != null) {
            ...
            config = (Map<String, Object>) ConstantUtil.get("YearRasterStatisticsProcess");
        }
