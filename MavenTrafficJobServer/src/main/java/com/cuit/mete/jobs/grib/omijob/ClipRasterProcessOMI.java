 ...
 * 用于批量裁剪栅格、并输出文件
 */
public class ClipRasterProcessOMI extends BaseJob {

    private static final Logger logger = Logger.getLogger(ClipRasterProcessOMI.class);
    ...
    public void startJob(JobExecutionContext jobExecutionContext) throws JobExecutionException {
        ...
        Map<String,String> uviClipMap = (Map<String, String>) config.get("OMI_NO2_Clip");
        //获取配置文件中待裁剪栅格文件的路径
