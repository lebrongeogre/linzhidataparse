...
public class AqiCityObsData {
    ...
    public AqiCityObsData() {
    }

    public AqiCityObsData(String code, String citycode, String cityname, Date timepoint, Double aqi, String primarypollutant, Integer index_mark, Double co, Integer co_mark, Double no2, Integer no2_mark, Double so2, Integer so2_mark, Double pm10, Integer pm10_mark, Double pm2_5, Integer pm2_5_mark, Double o3, Integer o3_mark, String state) {
        this.code = code;
    ...
    public String getTableName() {
        return "tb_da_aqicityrealtimedata";
    }

    @Override
    public String toString() {
        return "AqiCityObsData{" +
                "code='" + code + '\'' +
                ", citycode='" + citycode + '\'' +
                ", cityname='" + cityname + '\'' +
                ", timepoint=" + timepoint +
